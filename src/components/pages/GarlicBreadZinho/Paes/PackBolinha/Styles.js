...
const ContainerPackBolinha = styled.div`
  width: 100%;
  padding: 0;
  margin: 0;
  ...
  #container-img-paes-bolinha-tradicional {
    transition: all 0.2s;
    &:hover {
      filter: drop-shadow(0 0 0.4rem #f0aa2a);
    }
  }
  #container-img-paes-catupiry {
    transition: all 0.2s;
    &:hover {
      filter: drop-shadow(0 0 0.4rem #0076bb);
    }
  }
...
export default ContainerPackBolinha;
